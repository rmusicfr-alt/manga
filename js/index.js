// Главная страница Light Fox Manga
(function() {
    'use strict';
        ...
        try {
            ...
            carouselContainer.innerHTML = featuredManga.map((manga, index) => `
                <div class="carousel-slide ${index === 0 ? 'active' : ''}" 
                     style="background-image: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url('${manga.cover_url || manga.image || 'https://images.pexels.com/photos/1591056/pexels-photo-1591056.jpeg'}');">
                    ...
                    <div class="slide-content">
                        ...
                        <div class="slide-meta">
                            ...
                            <span class="slide-badge">Глав: ${manga.available_episodes || 0}/${manga.total_episodes || 0}</span>
                        </div>
            ...
            list.innerHTML = allManga.map(manga => {
                ...
                return `
                    <div class="update-item" onclick="window.location.href='player.html?id=${manga.id}'">
                        <img src="${manga.cover_url || manga.image || 'https://images.pexels.com/photos/1591062/pexels-photo-1591062.jpeg'}" 
                             alt="${manga.title}" 
                             class="update-image"
                             onerror="this.src='https://images.pexels.com/photos/1591447/pexels-photo-1591447.jpeg'">
    ...
    function waitForSystems() {
        return new Promise((resolve) => {
            ...
            const checkReady = () => {
                if (window.MangaAPI || attempts >= maxAttempts) {
                    resolve();
                } else {
                    attempts++;
